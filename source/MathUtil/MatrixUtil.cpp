...
#if (M3_TARGET_PLATFORM == M3_PLATFORM_ANDROID)
...
#if (M3_TARGET_PLATFORM == M3_PLATFORM_IOS)
...
#elif (M3_TARGET_PLATFORM == M3_PLATFORM_ANDROID)
    #if defined (__arm64__)
        #define INCLUDE_NEON64
    #elif defined (__ARM_NEON__)
        #define INCLUDE_NEON32
...
bool MatrixUtil::isNeon32Enabled()
{
#ifdef USE_NEON32
    return true;
#elif (defined (INCLUDE_NEON32) && (M3_TARGET_PLATFORM == M3_PLATFORM_ANDROID) )
...
bool MatrixUtil::isNeon64Enabled()
{
#ifdef USE_NEON64
    return true;
#else
...
void MatrixUtil::addMatrix(const float* m, float scalar, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::addMatrix(const float* m1, const float* m2, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::subtractMatrix(const float* m1, const float* m2, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::multiplyMatrix(const float* m, float scalar, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::multiplyMatrix(const float* m1, const float* m2, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::negateMatrix(const float* m, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::transposeMatrix(const float* m, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::transformVec4(const float* m, float x, float y, float z, float w, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::transformVec4(const float* m, const float* v, float* dst)
{
#ifdef USE_NEON32
...
void MatrixUtil::crossVec3(const float* v1, const float* v2, float* dst)
{
#ifdef USE_NEON32
