...
void NewProjectDialog::SetupUI() {
  ...
  mProjectPathEdit->setText(QDir::homePath() +
                            "/GNXEngine"); // 默认为用户主目录
  ...
  // 连接信号
  connect(mProjectNameEdit, &QLineEdit::textChanged, this,
          &NewProjectDialog::ValidateInput);
  connect(mProjectPathEdit, &QLineEdit::textChanged, this,
          &NewProjectDialog::ValidateInput);
  connect(mBrowseButton, &QPushButton::clicked, this,
          &NewProjectDialog::OnBrowseButtonClicked);
  connect(mCreateButton, &QPushButton::clicked, this,
          &NewProjectDialog::OnCreateButtonClicked);
  connect(mCancelButton, &QPushButton::clicked, this,
          &NewProjectDialog::OnCancelButtonClicked);
}
...
void NewProjectDialog::OnCancelButtonClicked() { reject(); }
