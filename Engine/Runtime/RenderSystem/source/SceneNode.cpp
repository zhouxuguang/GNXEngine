...
SceneNode * SceneNode::CreateChildSceneNode(const std::string &name, const Vector3f &translate, const Quaternionf &rotate, const Vector3f& scale)
{
    ...
    pNode->AddComponent<TransformComponent>(Transform(translate, rotate, scale));
                                          ...
                                          const Vector3f &scale)
{
    ...
    {
        MeshRenderer* meshRender = pNode->AddComponent<MeshRenderer>();
    ...
    {
        SkinnedMeshRenderer* meshRender = pNode->AddComponent<SkinnedMeshRenderer>();
        ...
        SkeletonAnimation* skeletonAnimation = pNode->AddComponent<SkeletonAnimation>();
                  ...
                  const Vector3f &scale)
{
    ...
    else
    {
        ...
        transform = pNode->AddComponent<TransformComponent>(Transform(translate, rotate, scale));
        pNode->MarkWorldTransformDirty();
    }
