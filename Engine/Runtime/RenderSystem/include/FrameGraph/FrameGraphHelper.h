...
[[nodiscard]] RENDERSYSTEM_API FrameGraphResource ImportBuffer(FrameGraph& fg, const std::string_view name, RenderCore::RCBufferPtr buffer);

[[nodiscard]] RENDERSYSTEM_API RenderCore::RCBufferPtr GetBuffer(FrameGraphPassResources& resources, FrameGraphResource id);
