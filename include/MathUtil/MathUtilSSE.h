...
void MatrixUtil::addMatrix(const __m128 m[4], float scalar, __m128 dst[4])
{
...
void MatrixUtil::addMatrix(const __m128 m1[4], const __m128 m2[4], __m128 dst[4])
{
...
void MatrixUtil::subtractMatrix(const __m128 m1[4], const __m128 m2[4], __m128 dst[4])
{
...
void MatrixUtil::multiplyMatrix(const __m128 m[4], float scalar, __m128 dst[4])
{
    __m128 s = _mm_set1_ps(scalar);
...
void MatrixUtil::multiplyMatrix(const __m128 m1[4], const __m128 m2[4], __m128 dst[4])
{
...
void MatrixUtil::negateMatrix(const __m128 m[4], __m128 dst[4])
{
...
void MatrixUtil::transposeMatrix(const __m128 m[4], __m128 dst[4])
{
...
void MatrixUtil::transformVec4(const __m128 m[4], const __m128& v, __m128& dst)
{
